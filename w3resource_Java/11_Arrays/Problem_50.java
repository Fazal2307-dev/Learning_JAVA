//Write a Java program to sort an array of positive integers from an array. In the
// sorted array the value of the first element should be maximum, the second value
// should be a minimum, third should be the second maximum, the fourth should be the
