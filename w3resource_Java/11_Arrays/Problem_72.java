//Write a Java program to find and print one continuous subarray (from a given array of
// integers) that if you only sort the said subarray in ascending order then the entire
