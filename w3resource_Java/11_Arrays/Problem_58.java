//Given two sorted arrays A and B of size p and q, write a Java program to merge elements
// of A with B by maintaining the sorted order i.e. fill A with first p smallest elements
