//Write a Java program to create all possible permutations of a given array of distinct
// integers.
...
public class Problem_68{
    ...
    public static void main(String[] args) throws Exception {
        ...
        List<List<Integer>> result1 = new Problem_68().permute(nums1);
        ...
        List<List<Integer>> result2 = new Problem_68().permute(nums2);
