//Write a Java program that returns the missing letter from an array of increasing
// letters (upper or lower). Assume there will always be one omission from the array.
