//Write a Java program to return an updated string using every character of even
// position from a given string.
import java.util.*;
...
public class Problem_99 {
    ...
    public static void main(String[] args) {
        Problem_99 m = new Problem_99(); // Create an instance of the Main class
