//Write a Java program to check whether a given substring appears in the middle of
// another string. Here middle means the difference between the number of characters
// to the left and right of the given substring is not more than 1.
import java.util.*;
...
public class Problem_75 {
    ...
    public static void main(String[] args) {
        Problem_75 m = new Problem_75(); // Create an instance of the Main class
