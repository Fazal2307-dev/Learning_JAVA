//Write a Java program to make up a string with each character before and after a
// non-empty substring whichever it appears in a non-empty given string.
import java.util.*;
...
public class Problem_85{
    ...
    public static void main(String[] args) {
        Problem_85 m = new Problem_85(); // Create an instance of the Main class
