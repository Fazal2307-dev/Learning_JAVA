//Write a Java program to return the substring that is between the first and last
// appearance of the substring 'toast' in the given string, or return an empty string
...
public class Problem_69{
    ...
    public static void main(String[] args) {
        Problem_69 m = new Problem_69(); // Create an instance of the Main class
