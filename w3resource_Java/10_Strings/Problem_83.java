//Write a Java program to create a string from two given strings. This is so that each
// character of the two strings appears individually in the created string.
import java.util.*;
...
public class Problem_83{
    ...
    public static void main(String[] args) {
        Problem_83 m = new Problem_83(); // Create an instance of the Main class
