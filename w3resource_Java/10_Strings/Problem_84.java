//Write a Java program to make an original string made of p number of characters from
// the first character in a given string. This is followed by p-1 number of characters
// till p is greater than zero.
import java.util.*;
...
public class Problem_84{
    ...
    public static void main(String[] args) {
        Problem_84 m = new Problem_84(); // Create an instance of the Main class
