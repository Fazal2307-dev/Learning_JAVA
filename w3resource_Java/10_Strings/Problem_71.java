//Write a Java program to check two given strings whether any of them appears at the
// end of the other string (ignore case sensitivity).
import java.util.*;
...
public class Problem_71{
    ...
    public static void main(String[] args) {
        Problem_71 m = new Problem_71(); // Create an instance of the Main class
