//Write a Java program to check whether a prefix string created using the first
// specific character in a given string appears somewhere else in the string.
import java.util.*;
...
public class Problem_74 {
    ...
    public static void main(String[] args) {
        Problem_74 m = new Problem_74(); // Create an instance of the Main class
