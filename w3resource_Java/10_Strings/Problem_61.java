//Write a Java program to create a new string taking specified number of characters
// from first and last position of a given string.
import java.util.*;
...
public class Problem_61{
    ...
    public static void main(String[] args) {
        Problem_61 m = new Problem_61(); // Create an instance of the Main class
