//Write a Java program to count the number of words ending in 'm' or 'n' (not case
// sensitive) in a given text.
import java.util.*;
...
public class Problem_91 {
    ...
    public static void main(String[] args) {
        Problem_91 m = new Problem_91(); // Create an instance of the Main class
