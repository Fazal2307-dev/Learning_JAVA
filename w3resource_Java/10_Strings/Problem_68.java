//Write Java program to read a string and return after removing specified characters
// and their immediate left and right adjacent characters.
import java.util.*;
...
public class Problem_68 {
    ...
    public static void main(String[] args) {
        Problem_68 m = new Problem_68(); // Create an instance of the Main class
