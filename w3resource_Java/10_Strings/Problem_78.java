//Write a Java program to repeat a specific number of characters for a specific number
// of times from the last part of a given string.
import java.util.*;
...
public class Problem_78{
    ...
    public static void main(String[] args) {
        Problem_78 m = new Problem_78(); // Create an instance of the Main class
