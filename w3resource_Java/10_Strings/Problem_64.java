//Write a Java program to read a string. If a substring of length two appears at both
// its beginning and end, return a string without the substring at the beginning;
...
public class Problem_64{
    ...
    public static void main(String[] args) {
        Problem_64 m = new Problem_64(); // Create an instance of the Main class
