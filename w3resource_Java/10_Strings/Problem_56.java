//Write a Java program that appends two strings, omitting one character if the
// concatenation creates double characters.
import java.util.*;
...
public class Problem_56{
    ...
    public static void main(String[] args) {
        Problem_56 m = new Problem_56(); // Create an instance of the Main class
