...
// If the strings are different lengths, remove characters from the beginning of the
// longer string and make them equal lengths.
import java.util.*;
...
public class Problem_60{
    ...
    public static void main(String[] args) {
        Problem_60 m = new Problem_60(); // Create an instance of the Main class
