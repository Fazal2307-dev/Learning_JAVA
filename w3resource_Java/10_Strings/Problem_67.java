//Write a Java program to read a string and remove the first two characters if one or
// both are equal to a specified character, otherwise leave them unchanged.
import java.util.*;
...
public class Problem_67{
    ...
    public static void main(String[] args) {
        Problem_67 m = new Problem_67(); // Create an instance of the Main class
