//Write a Java program to create a string from a given string. This is done after
// removing the 2nd character from the substring of length three starting with 'z' and
// ending with 'g' presents in the said string.
import java.util.*;
...
public class Problem_79 {
    ...
    public static void main(String[] args) {
        Problem_79 m = new Problem_79(); // Create an instance of the Main class
