//Write a Java program to check whether a specified character is happy or not. A
// character is happy when the same character appears to its left or right in a string.
import java.util.*;
...
public class Problem_87 {
    ...
    public static void main(String[] args) {
        Problem_87 m = new Problem_87(); // Create an instance of the Main class
