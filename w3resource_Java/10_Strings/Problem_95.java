//Write a Java program to return the sum of the digits present in the given string. In
// the absence of digits, the sum is 0.
import java.util.*;
...
public class Problem_95 {
    ...
    public static void main(String[] args) {
        Problem_95 m = new Problem_95(); // Create an instance of the Main class
