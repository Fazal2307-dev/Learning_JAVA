//Write a Java program to count how many times the substring 'life' appears anywhere in
// a given string. Counting can also happen with the substring 'li?e', any character
// instead of 'f'.
import java.util.*;
...
public class Problem_76 {
    ...
    public static void main(String[] args) {
        Problem_76 m = new Problem_76(); // Create an instance of the Main class
