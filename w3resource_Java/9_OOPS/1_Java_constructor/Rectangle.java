//Write a Java program to create a class called Rectangle with instance variables length
// and width. Implement a parameterized constructor and a copy constructor that
// initializes a new object using the values of an existing object. Print the values of
// the variables.
