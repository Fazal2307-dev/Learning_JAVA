//Write a Java program to create a class called Car with instance variables make, model,
   //     and year. Implement a parameterized constructor that initializes these variables
//and assigns default values if not provided. Print the values of the variables.
