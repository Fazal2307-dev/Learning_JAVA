//Write a Java program to print mode values from a given sequence of
// integers. The mode value is the element that occurs most frequently.
// If there are several mode values, print them in ascending order.
