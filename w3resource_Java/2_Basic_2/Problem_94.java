//Write a Java program that accepts three integers and checks whether
// the sum of the first two integers is greater than the third integer.
// Three integers are in the interval [-231, 231 ].
