//Write a Java program to rearrange the alphabets in the order followed
// by the sum of digits in a given string containing uppercase alphabets
// and integer digits (from 0 to 9).
import java.util.*;
import java.lang.*;
