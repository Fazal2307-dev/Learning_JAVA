//Write a Java program that accepts an even number (n should be greater
// than or equal to 4 and less than or equal to 50,000, a Goldbach number)
// from the user and creates combinations that express the given number
// as a sum of two prime numbers. Print the number of combinations.
