//Write a Java program to find the median of the numbers inside the
// window (size k) at each step in a given array of integers with
// duplicate numbers. Move the window to the array start.
import java.util.*;
