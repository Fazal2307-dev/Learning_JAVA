//Let us use the letter H to mean "hundred", the letter T to mean "ten" and
// “1, 2, . . . n” to represent the one digit n (<10). Using the given
// format, write a Java program that converts 3 digits positive numbers.
// For example, 234 should be output as BBSSS1234 because it has 2
// "hundreds", 3 "ten", and 4 ones.
