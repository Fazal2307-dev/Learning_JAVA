//Write a Java program that reads n digits (given) chosen from 0 to 9
// and prints the number of combinations where the sum of the digits
// equals another given number (s). Do not use the same digits in a
// combination.
import java.util.*;
