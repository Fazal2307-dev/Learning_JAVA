//Write a Java program that reads a text (only alphabetical characters
// and spaces) and prints two words. The first one is the word which is
// frequently used in the text. The second one is the word with the most
// letters.
